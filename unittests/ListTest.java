...
public class ListTest {
    ...
    private org.python.types.List py_list_from_java_ints(int[] array) {
        java.util.List<org.python.Object> list_of_ints = Arrays.stream(array).mapToObj(n -> org.python.types.Int.getInt(n)).collect(Collectors.toList());
    ...
    @Test
    public void test__contains__sorted() {
        int[] array = new Random().ints(100000, 0, 90000).toArray();
        Arrays.sort(array);
        org.python.types.List java_list = py_list_from_java_ints(array);
        assertEquals(java_list.__contains__(org.python.types.Int.getInt(array[5000]), Bool.TRUE), org.python.types.Bool.TRUE);
        assertEquals(java_list.__contains__(org.python.types.Int.getInt(array[95000]), Bool.TRUE), org.python.types.Bool.TRUE);
        assertEquals(java_list.__contains__(org.python.types.Int.getInt(91000), Bool.TRUE), Bool.FALSE);
    }

    @Test
    public void test__contains__sorted__false() {
        int[] array = new Random().ints(100000, 0, 90000).toArray();
        Arrays.sort(array);
        org.python.types.List java_list = py_list_from_java_ints(array);
        assertEquals(java_list.__contains__(org.python.types.Int.getInt(array[5000]), Bool.FALSE), org.python.types.Bool.TRUE);
        assertEquals(java_list.__contains__(org.python.types.Int.getInt(array[95000]), Bool.FALSE), org.python.types.Bool.TRUE);
        assertEquals(java_list.__contains__(org.python.types.Int.getInt(91000), Bool.FALSE), Bool.FALSE);
    }
