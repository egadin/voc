...
public class DateTime extends org.python.types.Object {
    ...
    @org.python.Method(__doc__ = "returns comparison true/false")
    public org.python.types.Bool __eq__(DateTime toCompare) {
        String stringToCompare = toCompare.toString();
        String baseString = this.toString();

        return new org.python.types.Bool(stringToCompare == baseString);
    }

    @org.python.Method(__doc__ = "returns comparison true/false")
    public boolean __gt__(DateTime toCompare) {
        //Attempted to break out the comparisons by creating an array containing the attributes and iterating over that
        //by doing this.[array attribute] to reuse the comparison statements, however I didn't get that to work...
        if (((org.python.types.Int) this.year).value < ((org.python.types.Int) toCompare.year).value)
            return false;
        else if (((org.python.types.Int) this.month).value < ((org.python.types.Int) toCompare.month).value)
            return false;
        else if (((org.python.types.Int) this.day).value < ((org.python.types.Int) toCompare.day).value)
            return false;
        else if (((org.python.types.Int) this.hour).value < ((org.python.types.Int) toCompare.hour).value)
            return false;
        else if (((org.python.types.Int) this.minute).value < ((org.python.types.Int) toCompare.minute).value)
            return false;
        else if (((org.python.types.Int) this.second).value < ((org.python.types.Int) toCompare.second).value)
            return false;
        else if (((org.python.types.Int) this.microsecond).value < ((org.python.types.Int) toCompare.microsecond).value)
            return false;
    ...
    @org.python.Method(__doc__ = "returns comparison true/false")
    public boolean __lt__(DateTime toCompare) {
        //Attempted to break out the comparisons by creating an array containing the attributes and iterating over that
        //by doing this.[array attribute] to reuse the comparison statements, however I didn't get that to work...
        if (((org.python.types.Int) this.year).value > ((org.python.types.Int) toCompare.year).value)
            return false;
